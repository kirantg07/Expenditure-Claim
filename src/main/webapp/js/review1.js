...
console.log("Hours indian is " + hoursIndian);
...
// Display the formatted date
console.log("Indian date is " + IndianDatee);
...
function find() {
	...
	console.log("uBillHidden " + uBillHidden);
	...
	console.log("viewBill lnk is " + viewBillLink);
	// const    id =  index + 1;

	console.log("particulars is ", particulars);
	console.log("bill No is ", bno);
	...
	console.log("Retrieved bill date is " + RetrievedBillDate);
	...
	/*tableRow.querySelector("#uBill").value = uploadBill;*/
...
function update(res) {
	...
	// var slNo = document.getElementById("sl").value;
	var slNo = "10";
	...
	/* var managerApproval = res;
	 var reclaimedDate = date;*/
	...
	console.log("Updated claimed date is " + claimedDate)
	...
	/* console.log("id is " + id);*/
	console.log("mApproval is " + mApproval);
	console.log("managerApproval is " + managerApproval);
	console.log("reclaimedDate is " + reclaimedDate);
			...
			fetch('EditUserData', {
				...
				.then(data => {
					if (data.success) {
						...
						setTimeout(() => {
							window.location.href = 'review1.jsp';
						}, 6000);
					} else {
...
function updateDateLimits() {
	...
	// Set the bDate max attribute to the current date
...
function filterTable() {
	...
	tableRows.forEach(function(row) {
		...
		console.log("manager approval row data is " + rowManagerApproval);
...
function validateFields() {
	const particularsEdit = document.querySelector("#parti").value;
	const billNoEdit = document.querySelector("#bNo").value;
	const billDateEdit = document.querySelector("#bDate").value;
	const amountEdit = document.querySelector("#amo").value;
	

	if (particularsEdit === "" || billNoEdit === "" || billDateEdit === "" || amountEdit === ""  ) {
