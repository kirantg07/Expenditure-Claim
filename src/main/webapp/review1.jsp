...
%>
		...
		<div class="navContainer">
			...
			<div class="leftContainer">
				<nav class="navText menu menu-1">
					<a href="create.jsp" class="nav-link">Create</a> <a
						href="review1.jsp" class="nav-link">My Forms</a>
				</nav>
	...
	<div class="profile">
		...
		<button class="profileButton">
			<a href="changePassword.jsp?sourcePage=review">Change password</a>
		</button>
		<button class="profileButton">
	...
	//String filePath = request.getServletContext().getRealPath("/WEB-INF/lib/table.json");
