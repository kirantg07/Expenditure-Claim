...
@WebServlet("/SubmitActionManager")
public class SubmitActionManager extends HttpServlet {
...
//            System.out.println(requestData.toString());
	...
	private void updateInformation(JSONArray newDataArray, JSONObject info) {
		for (Object entry : newDataArray) {
			...
			String mApproval = (String) row.get("managerApproval");
			String mRemarks = (String) row.get("managerRemarks");
			...
			for (Object key : info.keySet()) {
				...
				for (Object item : expenseItems) {
					...
					if (expenseItem.get("id").toString().equals(id)
						...
						expenseItem.put("managerRemarks", mRemarks);
						expenseItem.put("managerApproval", mApproval);
